<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="gestao financeira.aspx.cs" Inherits="AAP__Educar_na_Fatec.gestao_financeira" %>
...
<header id="submenu">
    <h2>Gestão de Financeira</h2>
    <img id="financeira" src="imagens/financeira.png" />
</header>
...
<div id="corpo">
        ...
        <p>Faça os testes de Gestão Financeira e ao final envie se teste clicando no botão no final da página.</p><br>

        <input id="btnEnviarFinanceira" type="reset" name="btnEnviar" value="Enviar Teste de Gestão financeira">
