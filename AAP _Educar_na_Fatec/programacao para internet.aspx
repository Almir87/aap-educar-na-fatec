<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="programacao para internet.aspx.cs" Inherits="AAP__Educar_na_Fatec.programacao_para_internet" %>
...
<header id="submenu">
    ...
    <img id="prginternet" src="imagens/prginternet.png" />
</header>
...
<div id="corpo">
        ...
        <p>Faça os testes de Programação para internet e ao final envie se teste clicando no botão no final da página.
        </p><br>

        <input id="btnEnviarprpinternet" type="reset" name="btnEnviar"
            value="Enviar Teste de Programação para Internet">
