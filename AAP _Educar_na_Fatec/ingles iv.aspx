<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="ingles iv.aspx.cs" Inherits="AAP__Educar_na_Fatec.ingles_iv" %>
...
<header id="submenu">
    <h2>Gestão de Inglês IV</h2>
    <img id="ingles" src="imagens/ingles.png" />
</header>
...
<div id="corpo">
        ...
        <p>Faça os testes de Inglês e ao final envie se teste clicando no botão no final da página.</p><br>

        <input id="btnEnviarIngles" type="reset" name="btnEnviar" value="Enviar Teste de Inglês IV">
